...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6ed275","is-html-6ed275","is-jsdelivr-6ed275","is-gtm-6ed275","is-gravatar-6ed275","is-theme-6ed275","is-cdn-6ed275","is-json-6ed275","is-custom-6ed275"];
      return Promise.all(
        names
