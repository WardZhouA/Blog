...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-89969e","is-html-89969e","is-jsdelivr-89969e","is-gtm-89969e","is-gravatar-89969e","is-theme-89969e","is-cdn-89969e","is-json-89969e","is-custom-89969e","is-img-89969e"];
      return Promise.all(
        names
