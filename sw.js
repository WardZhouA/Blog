...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b9d8e9","is-html-b9d8e9","is-jsdelivr-b9d8e9","is-gtm-b9d8e9","is-gravatar-b9d8e9","is-theme-b9d8e9","is-cdn-b9d8e9","is-json-b9d8e9","is-custom-b9d8e9","is-img-b9d8e9"];
      return Promise.all(
        names
