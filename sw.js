...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-853c91","is-html-853c91","is-jsdelivr-853c91","is-gtm-853c91","is-gravatar-853c91","is-theme-853c91","is-cdn-853c91","is-json-853c91"];
      return Promise.all(
        names
