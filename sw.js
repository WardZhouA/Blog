...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0f7b58","is-html-0f7b58","is-jsdelivr-0f7b58","is-gtm-0f7b58","is-gravatar-0f7b58","is-theme-0f7b58","is-cdn-0f7b58","is-json-0f7b58","is-custom-0f7b58"];
      return Promise.all(
        names
