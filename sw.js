...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f523af","is-html-f523af","is-jsdelivr-f523af","is-gtm-f523af","is-gravatar-f523af","is-theme-f523af","is-cdn-f523af","is-json-f523af"];
      return Promise.all(
        names
