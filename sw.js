...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ca3bf6","is-html-ca3bf6","is-jsdelivr-ca3bf6","is-gtm-ca3bf6","is-gravatar-ca3bf6","is-theme-ca3bf6","is-cdn-ca3bf6","is-json-ca3bf6","is-custom-ca3bf6","is-img-ca3bf6"];
      return Promise.all(
        names
