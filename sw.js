...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-fdc6d5","is-html-fdc6d5","is-jsdelivr-fdc6d5","is-gtm-fdc6d5","is-gravatar-fdc6d5","is-theme-fdc6d5","is-cdn-fdc6d5","is-json-fdc6d5"];
      return Promise.all(
        names
