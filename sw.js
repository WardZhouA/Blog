...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9a8e44","is-html-9a8e44","is-jsdelivr-9a8e44","is-gtm-9a8e44","is-gravatar-9a8e44","is-theme-9a8e44","is-cdn-9a8e44","is-json-9a8e44"];
      return Promise.all(
        names
