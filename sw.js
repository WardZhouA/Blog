...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ebabb8","is-html-ebabb8","is-jsdelivr-ebabb8","is-gtm-ebabb8","is-gravatar-ebabb8","is-theme-ebabb8","is-cdn-ebabb8","is-json-ebabb8","is-custom-ebabb8","is-img-ebabb8"];
      return Promise.all(
        names
