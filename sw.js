...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-64156c","is-html-64156c","is-jsdelivr-64156c","is-gtm-64156c","is-gravatar-64156c","is-theme-64156c","is-cdn-64156c","is-json-64156c"];
      return Promise.all(
        names
