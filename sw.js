...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-a2961c","is-html-a2961c","is-jsdelivr-a2961c","is-gtm-a2961c","is-gravatar-a2961c","is-theme-a2961c","is-cdn-a2961c","is-json-a2961c"];
      return Promise.all(
        names
