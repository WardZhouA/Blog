...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-846df3","is-html-846df3","is-jsdelivr-846df3","is-gtm-846df3","is-gravatar-846df3","is-theme-846df3","is-cdn-846df3","is-json-846df3","is-custom-846df3","is-img-846df3"];
      return Promise.all(
        names
