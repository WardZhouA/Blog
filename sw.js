...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-fa20b4","is-html-fa20b4","is-jsdelivr-fa20b4","is-gtm-fa20b4","is-gravatar-fa20b4","is-theme-fa20b4","is-cdn-fa20b4","is-json-fa20b4"];
      return Promise.all(
        names
