...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4bafcf","is-html-4bafcf","is-jsdelivr-4bafcf","is-gtm-4bafcf","is-gravatar-4bafcf","is-theme-4bafcf","is-cdn-4bafcf","is-json-4bafcf"];
      return Promise.all(
        names
