...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f3e41f","is-html-f3e41f","is-jsdelivr-f3e41f","is-gtm-f3e41f","is-gravatar-f3e41f","is-theme-f3e41f","is-cdn-f3e41f","is-json-f3e41f","is-custom-f3e41f","is-img-f3e41f"];
      return Promise.all(
        names
