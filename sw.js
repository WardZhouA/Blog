...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-62bf23","is-html-62bf23","is-jsdelivr-62bf23","is-gtm-62bf23","is-gravatar-62bf23","is-theme-62bf23","is-cdn-62bf23","is-json-62bf23"];
      return Promise.all(
        names
