...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-8bada3","is-html-8bada3","is-jsdelivr-8bada3","is-gtm-8bada3","is-gravatar-8bada3","is-theme-8bada3","is-cdn-8bada3","is-json-8bada3"];
      return Promise.all(
        names
