...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6ea003","is-html-6ea003","is-jsdelivr-6ea003","is-gtm-6ea003","is-gravatar-6ea003","is-theme-6ea003","is-cdn-6ea003","is-json-6ea003"];
      return Promise.all(
        names
