...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-569c46","is-html-569c46","is-jsdelivr-569c46","is-gtm-569c46","is-gravatar-569c46","is-theme-569c46","is-cdn-569c46","is-json-569c46","is-custom-569c46","is-img-569c46"];
      return Promise.all(
        names
