...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-bc473f","is-html-bc473f","is-jsdelivr-bc473f","is-gtm-bc473f","is-gravatar-bc473f","is-theme-bc473f","is-cdn-bc473f","is-json-bc473f"];
      return Promise.all(
        names
