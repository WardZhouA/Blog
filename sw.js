...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-7f3ef9","is-html-7f3ef9","is-jsdelivr-7f3ef9","is-gtm-7f3ef9","is-gravatar-7f3ef9","is-theme-7f3ef9","is-cdn-7f3ef9","is-json-7f3ef9"];
      return Promise.all(
        names
