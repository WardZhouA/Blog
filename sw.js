...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4f05d8","is-html-4f05d8","is-jsdelivr-4f05d8","is-gtm-4f05d8","is-gravatar-4f05d8","is-theme-4f05d8","is-cdn-4f05d8","is-json-4f05d8"];
      return Promise.all(
        names
