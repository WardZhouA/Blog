...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-1c1e2a","is-html-1c1e2a","is-jsdelivr-1c1e2a","is-gtm-1c1e2a","is-gravatar-1c1e2a","is-theme-1c1e2a","is-cdn-1c1e2a","is-json-1c1e2a","is-custom-1c1e2a","is-img-1c1e2a"];
      return Promise.all(
        names
