...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ccdeab","is-html-ccdeab","is-jsdelivr-ccdeab","is-gtm-ccdeab","is-gravatar-ccdeab","is-theme-ccdeab","is-cdn-ccdeab","is-json-ccdeab","is-custom-ccdeab","is-img-ccdeab"];
      return Promise.all(
        names
