...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-14f4a2","is-html-14f4a2","is-jsdelivr-14f4a2","is-gtm-14f4a2","is-gravatar-14f4a2","is-theme-14f4a2","is-cdn-14f4a2","is-json-14f4a2"];
      return Promise.all(
        names
