...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-82aa56","is-html-82aa56","is-jsdelivr-82aa56","is-gtm-82aa56","is-gravatar-82aa56","is-theme-82aa56","is-cdn-82aa56","is-json-82aa56"];
      return Promise.all(
        names
