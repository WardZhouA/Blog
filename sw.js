...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ef4b83","is-html-ef4b83","is-jsdelivr-ef4b83","is-gtm-ef4b83","is-gravatar-ef4b83","is-theme-ef4b83","is-cdn-ef4b83","is-json-ef4b83"];
      return Promise.all(
        names
