...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-702847","is-html-702847","is-jsdelivr-702847","is-gtm-702847","is-gravatar-702847","is-theme-702847","is-cdn-702847","is-json-702847"];
      return Promise.all(
        names
