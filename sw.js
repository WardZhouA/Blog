...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f344e8","is-html-f344e8","is-jsdelivr-f344e8","is-gtm-f344e8","is-gravatar-f344e8","is-theme-f344e8","is-cdn-f344e8","is-json-f344e8"];
      return Promise.all(
        names
