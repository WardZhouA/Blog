...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-16c007","is-html-16c007","is-jsdelivr-16c007","is-gtm-16c007","is-gravatar-16c007","is-theme-16c007","is-cdn-16c007","is-json-16c007","is-custom-16c007"];
      return Promise.all(
        names
