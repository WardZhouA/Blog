...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e3dc0b","is-html-e3dc0b","is-jsdelivr-e3dc0b","is-gtm-e3dc0b","is-gravatar-e3dc0b","is-theme-e3dc0b","is-cdn-e3dc0b","is-json-e3dc0b","is-custom-e3dc0b","is-img-e3dc0b"];
      return Promise.all(
        names
