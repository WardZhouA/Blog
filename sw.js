...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-38f749","is-html-38f749","is-jsdelivr-38f749","is-gtm-38f749","is-gravatar-38f749","is-theme-38f749","is-cdn-38f749","is-json-38f749"];
      return Promise.all(
        names
