...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-350ae6","is-html-350ae6","is-jsdelivr-350ae6","is-gtm-350ae6","is-gravatar-350ae6","is-theme-350ae6","is-cdn-350ae6","is-json-350ae6","is-custom-350ae6","is-img-350ae6"];
      return Promise.all(
        names
