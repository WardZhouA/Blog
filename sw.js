...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-dc4e37","is-html-dc4e37","is-jsdelivr-dc4e37","is-gtm-dc4e37","is-gravatar-dc4e37","is-theme-dc4e37","is-cdn-dc4e37","is-json-dc4e37"];
      return Promise.all(
        names
